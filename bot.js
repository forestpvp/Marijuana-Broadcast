...
const client = new Discord.Client(NjAyMjE0MTA2NDcyMjUxNDIz.XTNl2w.ONyhZOUSLPzghawJg6Fr46p9PkU);
const prefix = "$";



client.on('ready', (NjAyMjE0MTA2NDcyMjUxNDIz.XTNl2w.ONyhZOUSLPzghawJg6Fr46p9PkU) => {
   console.log(`----------------`);
